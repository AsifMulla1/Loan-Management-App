        ...
        <div class="row">
            ...
            <div class="col-11 col-sm-11 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center py-4">        
              <h4 class="mb-3 text-center">
              	<span class=" font-weight-bold  text-center all_head">Pendding Report</span></h4>   
                ...
                success: function(res) {
                    ...
                    if (Array.isArray(data) && data.length > 0) {
                        data.forEach(function(row) {
                            totalHaptaAmount += parseFloat(row.PaidHaptaAmount) || 0;
                            totalDandRakkam += parseFloat(row.PaidDandAmount) || 0;
                        ...
                        tableBody.append(
                            `<tr>
                                ...
                                <td><strong>${totalDandRakkam.toFixed(2)}</strong></td>
                                <td colspan="2"></td>
                            </tr>`
                        );
                    } else {
