...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="<?=base_url() ?>Assets/img/Logo_1.png" sizes="180x180">
    <link rel="icon" href="<?=base_url() ?>Assets/img/Logo_1.png" sizes="32x32" type="image/png">
    <link rel="icon" href="<?=base_url() ?>Assets/img/Logo_1.png" sizes="16x16" type="image/png">
        ...
        <div class="row h-100">
            <div class="col-10 col-md-6 col-lg-5 col-xl-3 mx-auto text-center align-self-center">
                <p class="mt-4"><span class="text-secondary">
                        <img src="<?=base_url() ?>Assets/img/loader.svg" alt=""
                            style="height: 50px;width: 50px;" /></span></p>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="appointmentDropdown" role="button"
                                ...
                                <div class="arrow">
                                    <i class="bi bi-chevron-down plus"></i> <i
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="appointmentDropdown" role="button"
                                ...
                                <div class="col">रिपोर्ट (Reports)</div>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="appointmentDropdown">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?=base_url("PenddingReport") ?>" tabindex="-1">
                                        <div class="avatar avatar-40 icon">
                                            <!-- <i class="bi bi-bell"></i> -->
                                        </div>
                                        <div class="col">राहीलेला कलेक्षण (Date)</div>
                                        <!-- <div class="arrow"><i class="bi bi-chevron-right"></i></div> -->
                                    </a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="appointmentDropdown">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?=base_url("Transection/create") ?>" tabindex="-1">
                                        <div class="avatar avatar-40 icon">
                                            <!-- <i class="bi bi-bell"></i> -->
                                        </div>
                                        <div class="col">ट्रान्सएकशन</div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?=base_url("Transection/virify") ?>" tabindex="-1">
                                        <div class="avatar avatar-40 icon">
                                            <!-- <i class="bi bi-bell"></i> -->
                                        </div>
                                        <div class="col">वेरिफिकेशनचे लिस्ट</div>
                                        <!-- <div class="arrow"><i class="bi bi-chevron-right"></i></div> -->
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?=base_url("TransectionReport") ?>" tabindex="-1">
                                        <div class="avatar avatar-40 icon">
                                            <!-- <i class="bi bi-bell"></i> -->
                                        </div>
                                        <div class="col">ट्रान्सएकशन रिपोर्ट (Date)</div>
                                        <!-- <div class="arrow"><i class="bi bi-chevron-right"></i></div> -->
                                    </a>
                                </li>
            ...
            <div class="row">
                ...
                <div class="col text-center">
                    <div class="logo-small">
                        ...
                        <span class="font-weight-bold  text-center all_head" style="color: #dd1177 !important;">
                            </span>
                        <!-- <h5><span class="text-secondary fw-light"> Clientel</span></h5> -->
                    </div>
                </div>
                <div class="col-auto">
                    <a href="javascript:void(0)" target="_self" class="btn btn-light btn-44" onclick="history.back()">
                        <!-- <i class="fas fa-bell icon" style="line-height: 40px!important;"></i> -->
                        <i class="fas fa-arrow-left icon" style="line-height: 40px!important;"></i>
